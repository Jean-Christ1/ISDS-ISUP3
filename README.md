...
<a href="#top" class="btn btn-primary btn-sm" role="button" aria-pressed="true" style="color:white" data-toggle="popover">Retour au programme</a>
  ...
  <a id="3"></a>
<font color="darkslateblue" size=+2.5><b>[3. BLOC de spécialisation : UE - Spécialisation 1 et UE - Spécialisation 2]()</b></font>

<a id="3.1"></a>
<font color="dimgrey" size=+2.0><b>[3.1 UE - Spécialisation 2]()</b></font> 
...
- Etc.
Le but du calcul parallèle est d'aller p fois plus vite/loin avec p processeurs : augmenter la fréquence d’horloge, augmenter le nombre d’opérations effectuées en un cycle. 
  
  
    
 <a id="3.2"></a>
<font color="dimgrey" size=+2.0><b>[3.2 UE - Spécialisation 1]()</b></font> 
...
- Structurelles pour manipuler les résultats de calculs de modèles ou de codes de simulation numérique de phénomènes physiques.
